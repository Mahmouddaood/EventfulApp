...
const YoutubeIcon: React.FC<IconProps> = ({
  ...
  return (
    <Svg
      ...
      viewBox="0 0 508 508" >
      <Path fill="#FF312E" d="M504,378.8c0,68.8-56.4,125.2-125.2,125.2H129.2C60.4,504,4,448,4,378.8V129.6C4,60.8,60.4,4,129.2,4
     h249.6C447.6,4,504,60.4,504,129.6V378.8z"/>
      <Path fill="#FFFFFF" d="M406.4,189.2c0,0-2.8-22.4-12-32.4c-12-12.8-25.2-13.6-31.2-14.4c-44-3.2-109.2-3.6-109.2-3.6l0,0
