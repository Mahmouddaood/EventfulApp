...
const CreateEventIcon: React.FC<IconProps> = ({
  width,
  height,
  color,
  onPress,
  ...
  return (
    <Svg
      ...
      viewBox="0 0 504 504" >
      <Path fill="33A5D2" d="M477.6,216H288V26.8C288,13.6,277.2,4,264,4h-24c-13.2,0-24,9.6-24,22.8V216H26.4
	...
	c13.2,0,22.4-10.8,22.4-24v-24C500,227.2,490.8,216,477.6,216z"/>
      <Path fill="73BADD" d="M432,236H268V74V46.4V33.2c0-5.6-4.8-8.8-10.8-8.8h-10.8c-5.6,0-10.8,3.2-10.8,8.8V236H32.4
...
CreateEventIcon.defaultProps = {
  width: 10,
  height: 10,
  color: colors.mainColor,
};

export default memo(CreateEventIcon);
